...
flags.DEFINE_string('video', './data/video/license_plate.mp4', 'path to input video or set to 0 for webcam')
    ...
    while True:
        ...
        if return_value:
            ...
            if frame_num == vid.get(cv2.CAP_PROP_FRAME_COUNT):
                ...
                break
            raise ValueError('Video has ended or failed, try a different video format!')
